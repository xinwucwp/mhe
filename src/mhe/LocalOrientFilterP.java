...
public class LocalOrientFilterP {
   ...
   */
  public LocalOrientFilterP(double sigma1, double sigma2) {
   ...
   */
  public LocalOrientFilterP(double sigma1, double sigma2, double sigma3) {
    _rgfSmoother1 = (sigma1>=1.0)?new RecursiveGaussianFilterP(sigma1):null;
    if (sigma2==sigma1) {
      _rgfSmoother2 = _rgfSmoother1;
    } else {
      _rgfSmoother2 = (sigma2>=1.0)?new RecursiveGaussianFilterP(sigma2):null;
    }
    if (sigma3==sigma2) {
      _rgfSmoother3 = _rgfSmoother2;
    } else {
      _rgfSmoother3 = (sigma3>=1.0)?new RecursiveGaussianFilterP(sigma3):null;
    }
  ...
  {
    _rgfGradient1 = new RecursiveGaussianFilterP(sigma1);
    if (sigma2==sigma1) {
      _rgfGradient2 = _rgfGradient1;
    } else {
      _rgfGradient2 = new RecursiveGaussianFilterP(sigma2);
    }
    if (sigma3==sigma2) {
      _rgfGradient3 = _rgfGradient2;
    } else {
      _rgfGradient3 = new RecursiveGaussianFilterP(sigma3);
    }
  }
  ...
  private RecursiveGaussianFilterP _rgfGradient1;
  private RecursiveGaussianFilterP _rgfGradient2;
  private RecursiveGaussianFilterP _rgfGradient3;
  private RecursiveGaussianFilterP _rgfSmoother1;
  private RecursiveGaussianFilterP _rgfSmoother2;
  private RecursiveGaussianFilterP _rgfSmoother3;
